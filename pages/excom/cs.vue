<template>
  <div>
    <v-container class="mt-4">
      ...
      <v-row>
        <v-tabs v-model="cs_tabs" centered class="mb-4" height="40" slider-size="3" color="#00273E">
      ...
      <v-row class="justify-center">
        <v-tabs-items v-model="cs_tabs" class="w-100">
          <v-tab-item>
            <v-row class="d-flex justify-center my-15 bg-surface-variant">
              <div v-for="(excom, i) in cs_Excom22">
                <ExComCard 
                :key="i" 
                :name="excom.name" 
          ...
          <v-tab-item>
            <v-row class="d-flex justify-center my-15 bg-surface-variant">
              <div v-for="(excom, i) in cs_Excom21">
                <ExComCard 
                :key="i" 
                :name="excom.name" 
                :position="excom.position" 
          ...
          <v-tab-item>
            <v-row class="d-flex justify-center my-15 bg-surface-variant">
              <div v-for="(excom, i) in cs_Excom20">
                <ExComCard 
                :key="i" 
                :name="excom.name" 
                :position="excom.position" 
          ...
          <!-- <v-tab-item>
            <v-row class="d-flex justify-center my-15 bg-surface-variant">
              <div v-for="(excom, i) in cs_Excom19">
                <ExComCard 
                :key="i" 
                :name="excom.name" 
                :position="excom.position" 
          ...
          <v-tab-item>
            <v-row class="d-flex justify-center my-15 bg-surface-variant">
              <div v-for="(excom, i) in cs_Excom18">
                <ExComCard 
                :key="i" 
                :name="excom.name" 
                :position="excom.position" 
...
<script>
import { excom_cs_2018 } from "~/content/excom/2018/CS";
import { excom_cs_2019 } from "~/content/excom/2019/CS";
import { excom_cs_2020 } from "~/content/excom/2020/CS";
import { excom_cs_2021 } from "~/content/excom/2021/CS";
import { excom_cs_2022 } from "~/content/excom/2022/CS";
...
export default {
  ...
  data: () => ({
    cs_Excom18: excom_cs_2018,
    cs_Excom19: excom_cs_2019,
    cs_Excom20: excom_cs_2020,
    cs_Excom21: excom_cs_2021,
    cs_Excom22: excom_cs_2022,
    cs_tabs: null,
