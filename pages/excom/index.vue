    ...
    <v-container class="mt-4">
      ...
      <v-row class="excom-swap-tab-chapter">
        <v-btn-toggle>
          ...
          <a href="/excom/wie"><v-btn color="#702F8A">WIE Affinity Group</v-btn></a>
          <a href="/excom/cs"><v-btn color="#FFA300">CS Student Chapter</v-btn></a>
        </v-btn-toggle>
      </v-row>
      <v-row>
      ...
      <v-row class="justify-center">
        <v-tabs-items v-model="sb_tabs" class="w-100">
          ...
          <v-tab-item>
            <v-row class="d-flex justify-center my-15 bg-surface-variant">
              <div v-for="(excom, i) in sb_Excom21">
                <ExComCard 
                :key="i" 
                :name="excom.name" 
                :position="excom.position" 
...
<script>
import { excom_sb_2018 } from "~/content/excom/2018/SB";
import { excom_sb_2019 } from "~/content/excom/2019/SB";
...
export default {
  ...
  data: () => ({
    sb_Excom18: excom_sb_2018,
    sb_Excom19: excom_sb_2019,
