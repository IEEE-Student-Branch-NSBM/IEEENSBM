        ...
        <v-card>
          <v-card-title class="purple lighten-2">
            <h2 class="display-1 white--text font-weight-light">
              Arduino Workshop by IEEE NSBM WIE
            </h2>
          </v-card-title>
          <v-container>
            <v-row>
      ...
      >
        <v-card>
          <v-card-title class="cyan lighten-1">
            <h2 class="display-1 white--text font-weight-light">
              Annual General Meeting of the IEEE NSBM
            </h2>
          </v-card-title>
          <v-container>
            <v-row>
